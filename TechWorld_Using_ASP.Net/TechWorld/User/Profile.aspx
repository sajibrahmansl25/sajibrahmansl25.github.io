<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="TechWorld.User.Profile" %>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="tab-content ml-1" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                                            <asp:Repeater ID="rUserProfile" runat="server">
                                                <ItemTemplate>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3 col-md-2 col-5">
                                                            <label style="font-weight: bold;">Email Add.</label>
                                                        </div>
                                                        <div class="c0l-md-8 col-6">
                                                            <%# Eval("Email") %>
                                                        </div>
                                        ...
                                        <%-- Basic User Info Ends --%>
                                         ...
                                         <%-- Purchased History Info Starts --%>
                                        <div class="tab-pane fade" id="connectedServices" role="tabpanel" aria-labelledby="ConnectedServices-tab">
                                            <h3>Order History</h3>
                                        </div>
                                         <%-- Purchased History Info Ends --%>
